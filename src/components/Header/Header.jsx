                ...
                <div className="flex flex-wrap items-center justify-end max-w-screen-xl mx-auto p-4">
                    ...
                    <div className={barsDropDown===true?"items-center justify-between w-full sm:flex sm:w-full":"items-center justify-between hidden w-full sm:flex sm:w-full"}>
                        <ul className="flex items-center flex-col mt-4 font-medium sm:flex-row sm:justify-evenly sm:w-full">
                            <li>
                                <a href="#Proyects" onClick={handleBarsDropsDownPhone} className="block py-2 pl-3 pr-4 text-white sm:border-0 sm:p-0 dark:text-white dark:hover:bg-gray-700 dark:hover:bg-transparent dark:border-gray-700">Proyectos</a>
                            </li>
                            <li>
                                <a href="#Tecnologies" onClick={handleBarsDropsDownPhone} className="block py-2 pl-3 pr-4 text-white sm:border-0 sm:p-0 dark:text-white dark:hover:bg-gray-700 dark:hover:bg-transparent dark:border-gray-700">Tecnologías</a>
                            </li>
                            <li>
                                <a href="#AboutMe" onClick={handleBarsDropsDownPhone} className="block py-2 pl-3 pr-4 text-white sm:border-0 sm:p-0 dark:text-white dark:hover:bg-gray-700 dark:hover:bg-transparent dark:border-gray-700">Sobre mi</a>
                            </li>
                            <li>
                                <a href="#ContactMe" onClick={handleBarsDropsDownPhone} className="block py-2 pl-3 pr-4 text-white sm:border-0 sm:p-0 dark:text-white dark:hover:bg-gray-700 dark:hover:bg-transparent dark:border-gray-700">Contacto</a>
                            </li>
                        </ul>
                    </div>
                </div>
