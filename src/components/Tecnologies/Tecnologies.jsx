    ...
    return (
        <div className="max-w-screen-xl mx-auto mt-24 flex flex-col">
            ...
            <div className="flex flex-wrap justify-center mt-8 w-full">
                <div className="w-2/5 h-auto mx-auto sm:h-42 sm:w-36 bg-white/[.02] flex justify-center align-center flex-col sm:mx-12 my-3 rounded-xl border border-white/[.05]">
